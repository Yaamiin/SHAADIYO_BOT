...
from Shadow import BOT_USERNAME, OWNER_ID
from Shadow.config import get_str_key
from Shadow.function.pluginhelpers import convert_seconds_to_minutes as time_convert
from Shadow.function.pluginhelpers import fetch
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/8dc2346939ef1184fcf01.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/SHADIYObot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Shadow_Helper)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
